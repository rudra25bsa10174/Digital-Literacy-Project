...
Student Details
● Name – RUDRA RAI
● Registration number: 25BSA10174
● BTech (CSE- Cloud Computing)

📌 Project Overview
This project focuses on building a Digital Literacy Portfolio to develop essential skills required in today’s digital world. 
It covers creating a professional online presence, understanding digital tools, maintaining proper communication, and ensuring cyber safety.  
...
🧾 Introduction
As a Student Digital Ambassador, this project is undertaken with the aim of promoting digital literacy and responsible online behaviour among fellow students. 
In the present technology-driven environment, individuals frequently interact with various digital platforms; however, a comprehensive understanding of their effective, ethical, and secure usage is often lacking.  
...
The project is organised into five distinct tasks, each addressing a crucial aspect of digital literacy, including awareness creation, portfolio development, platform exploration, email etiquette, and cybercrime prevention. 
Through this initiative, the project aims to enhance digital awareness and prepare students for academic and professional success.  
...
Canva	Presentation & Design	Created digital literacy infographic
GitHub	Project Hosting & Version Control	Hosted repository and managed project files
LinkedIn	Professional Networking	Built professional profile for career growth
Kaggle	Academic Learning	Explored research content and academic resources
HackerRank	Coding Practice	Solved beginner problem to understand programming basics
Google Forms	Data Collection	Created digital literacy awareness quiz
Google Sheets	Data Analysis	Collected and viewed quiz responses
WhatsApp	Communication	Used for group communication (case study example)
Cyber Crime Portal	Reporting Cybercrime	Referenced for reporting online fraud cases
...
Student Declaration
I hereby declare that this Digital Literacy Project is my original work. 
All tasks, write-ups, and materials included in this repository have been completed by me.  
 
Any external resources used have been referred to only for understanding purposes and are properly acknowledged where applicable. 
This submission complies with the academic integrity guidelines of the course.
